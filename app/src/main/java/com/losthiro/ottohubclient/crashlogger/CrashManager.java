...
public class CrashManager implements Thread.UncaughtExceptionHandler {
    ...
    private String saveLog(Throwable e) {
        ...
        try {
            ...
            String fileName=StringUtils.strCat(new String[]{"OTTOHub_log_", SystemUtils.getDate("yyyy_MM_dd_HH_mm_ss_"), StringUtils.toStr(SystemUtils.getTime()), ".log"});
            File f=new File("/sdcard/OTTOHub/");
            FileUtils.createDir(f.toString());
            File log=new File(DeviceUtils.getAndroidSDK() >= Build.VERSION_CODES.R ?mContext.getExternalFilesDir(null): f, fileName);
