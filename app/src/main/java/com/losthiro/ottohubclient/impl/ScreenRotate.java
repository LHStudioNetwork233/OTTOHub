...
public class ScreenRotate {
	...
	private static ScreenRotate INSTANCE;
	...
	public static ScreenRotate getInstance(Context context) {
		if (INSTANCE == null) {
			INSTANCE = new ScreenRotate(context);
		}
		return INSTANCE;
	}
	...
	class OrientationSensorListener implements SensorEventListener {
		...
		public void onSensorChanged(SensorEvent event) {
			...
			if (isEffectSysSetting) {
				try {
					int isRotate = Settings.System.getInt(mActivity.getContentResolver(),
